...
/**
 * FrameworkVersionsFixture
 *
 */
class FrameworkVersionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'version' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'framework_versions_ibfk_1' => ['type' => 'foreign', 'columns' => ['framework_id'], 'references' => ['frameworks', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2015-08-13 12:29:32',
            'created_by' => 1,
            'modified' => '2015-08-13 12:29:32',
            'modified_by' => 1
        ],
    ];
}
