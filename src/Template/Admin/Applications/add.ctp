...
<div class="applications form">
    ...
    <fieldset>
        ...
        <div class="panel panel-default">
            ...
            echo $this->AlaxosForm->control('applications_frameworks.0.framework_version_id', ['type' => 'select', 'label' => false, 'empty' => true, 'id' => 'framework_version_select']);

//             echo $this->AlaxosForm->control('frameworks._ids', ['label' => false, 'options' => $frameworks, 'id' => 'frameworks_select']);

//             echo $this->AlaxosForm->control('frameworks.0.id', ['type' => 'select', 'label' => false, 'options' => $frameworks, 'empty' => true, 'id' => 'frameworks_select']);
//             echo $this->AlaxosForm->control('frameworks.0._joinData.framework_version_id', ['type' => 'select', 'label' => false, 'options' => $frameworkVersions, 'empty' => true, 'id' => 'framework_version_select']);

//             echo $this->AlaxosForm->control('frameworks.0.id', ['type' => 'select', 'label' => false, 'options' => $frameworks, 'empty' => true, 'id' => 'frameworks_select']);
//             echo $this->AlaxosForm->control('frameworks.0._joinData.framework_version_id', ['type' => 'select', 'label' => false, 'empty' => true, 'id' => 'framework_version_select']);
