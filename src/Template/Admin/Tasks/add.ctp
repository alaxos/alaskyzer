...
<div class="tasks form">
    ...
    <fieldset>
        ...
        <div class="panel panel-default">
            ...
            if($application_id = $this->request->getQuery('application_id'))
            {
            ...
            echo $this->AlaxosForm->control('task_category_id', ['options' => $taskCategories, 'empty' => true, 'label' => false, 'class' => 'form-control', 'id' => 'task_category_select']);
            echo '</div>';
            echo '</div>';
            ...
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->control('application_id', ['options' => $applications, 'empty' => true, 'label' => false, 'class' => 'form-control', 'id' => 'application_select']);
            echo '</div>';
            echo '</div>';
            ...
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->control('server_id', ['options' => $servers, 'empty' => true, 'label' => false, 'class' => 'form-control', 'id' => 'server_select']);
            echo '</div>';
            echo '</div>';
            ...
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->control('name', ['label' => false, 'class' => 'form-control', 'autofocus' => true]);
            echo '</div>';
            echo '</div>';
