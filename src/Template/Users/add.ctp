...
<div class="users form">
    ...
    <fieldset>
        ...
        <div class="panel panel-default">
            ...
            echo '<div class="form-group">';
            echo $this->AlaxosForm->label('external_id', __('external_id'), ['class' => 'col-sm-2 control-label']);
            echo '<div class="col-sm-5">';
            echo $this->AlaxosForm->input('external_id', ['label' => false, 'class' => 'form-control']);
            echo '</div>';
            echo '</div>';
